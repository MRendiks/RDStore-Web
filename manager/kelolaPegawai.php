<?php 
    ...
    $data = $rg->select($table);
     ...
     if(isset($_POST['btnInput'])){
        ...
        if($nama_user == "" || $username == "" || $password == "" || $confirm == ""){
            $response = ['response'=>'negative','alert'=>'Lengkapi Field !!!'];
        }else{
            $response = $rg->register($kd_user, $nama_user, $username, $password, $confirm, $redirect);
        }
    }
                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title mb-3">Input User</strong>
                        </div>
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <button name="btnInput" class="au-btn au-btn--green m-b-20" type="submit">Input User</button>
