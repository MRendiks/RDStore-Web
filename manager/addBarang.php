            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data">
                        <div class="card">
                        <div class="au-card-title" style="background-image:url('images/bg3.jpg');">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="text" placeholder="Merek Barang" class="form-control" name="merek_barang" value="<?php echo @$_POST['merek_barang'] ?>"> -->
