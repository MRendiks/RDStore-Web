...
<body>
	...
	<div class="page-wrapper">
		<aside class="menu-sidebar2">
			<div class="logo">
                <a href="">
                <img src="" alt="" width = "" height = "" style="margin-left:85px"/>
                </a>
            </div>
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            ...
                            <i class="fas fa-users"></i>Kelola Akun</a>
                        </li>
                        <li>
                                ...
                                <div class="header-button-item js-item-menu">
                                    ...
                                    <div class="search-dropdown js-dropdown">
                                        <form action="">
                                            ...
                                            <span class="search-dropdown__ico">
                                                <i class="zmdi zmdi-search"></i>
                                            </span>
                                        </form>
                                    </div>
				...
				switch($page){
                    ...
                    case 'addBarang':
                        ...
                        case 'viewBarangDetail':
                            ...
                            break;
                        case 'viewBarangEdit':
                            include "managern/viewBarangEdit.php";
                            break;
					default:
						$page = "dashboard";
