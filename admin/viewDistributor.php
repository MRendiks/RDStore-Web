<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        $cek      = $dis->selectCountWhere("table_barang","kd_barang","kd_distributor='$whereValues'");
        if ($cek['count'] > 0) {
            $response = ['response'=>'negative','alert'=>'Distributor ini sudah di pakai di barang tidak dapat di hapus'];
        }
        else
        {
